...
class EmailModel with ChangeNotifier {
  final List<Email> _emails = <Email>[
    ...
    Email(
        ...
        "25 minutes ago",
        "Brunch this weekend?",
        "I’ll be in your neighborhood doing errands on Saturday morning and wanted to ask if you would be up for having brunch at The Cake Facory?\n\nWould love to catch up with you!",
        "avatar1.jpg",
        "me",
        false,
        false,
    ...
    Email(
        ...
        "6 hrs ago",
        "Bonjour from Paris",
        "Here are some great shots from my trip to Paris this summer!",
        "avatar2.jpg",
        "Shawn, Melli, me",
        false,
        true,
    ...
    Email(
        ...
        "18 hrs ago",
        "Recipe to try",
        "We should make this one day when we do a brunch again. Looks super nice!",
        "avatar4.jpg",
        "Shawn, Melli, me",
        true,
        false,
    ...
    Email(
        "Frederik Schweiger",
        "22 hrs ago",
        "Reply Material Case Study",
        "Hey there, great news! Today I have finally published the source code for the Reply Material Design case study I have been working on over the last few weeks.\n\nYoucan find it on my GitHub account. Let me know what you think!\n\nCheers!",
        "avatar6.jpg",
        "me",
        false,
        false,
    ...
    Email(
        ...
        "What's up? I wanted to reach out to you because I though that you may know a trusted dog sitting place in central London?\n\nI have an important meeting with Jay on Friday next week so I need someone who can take care of Jimmy...",
        "avatar7.jpg",
        "me",
        false,
        false,
